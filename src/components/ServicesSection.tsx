      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {services.map((service) => (
            <div key={service.title} className="bg-soft-gray rounded-xl p-8 text-center hover:shadow-lg transition-shadow">
              <div className="flex justify-center mb-6">
                <img src={service.image} alt={service.title} className="h-28 w-28 object-contain" />
              </div>
              ...
              <a href="#" className="text-accent font-display font-semibold text-sm hover:underline">Learn More</a>
            </div>
          ))}
        </div>
      </div>
